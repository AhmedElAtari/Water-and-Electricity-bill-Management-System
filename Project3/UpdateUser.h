	...
	public:
		...
		UpdateUser(void)
		{
			...
			try{
				...
				con = conDatabase;
				cmdDataBase = gcnew MySqlCommand("SELECT `IDUtilisateur` as \"Numero Utilisateur\" , `UserName` as \"Nom Utilisateur\" , `Password` as \"Mot de Passe\", `IDDroit` as \"Droit\", `Etat` as \"Etat de compte\"  FROM greensoft.`utilisateur` WHERE 1", con);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &UpdateUser::dataGridView1_CellContentClick);
			// 
			// label7
			// 
			...
			this->label7->Size = System::Drawing::Size(253, 41);
			this->label7->TabIndex = 45;
			this->label7->Text = L"Modifier Utilisateur";
			// 
			// Ajouter
			// 
			...
			this->Ajouter->Click += gcnew System::EventHandler(this, &UpdateUser::Ajouter_Click);
			// 
			// Cancel
			// 
			...
			this->Cancel->Click += gcnew System::EventHandler(this, &UpdateUser::Cancel_Click);
			// 
			// label1
			// 
			...
			this->label1->Location = System::Drawing::Point(53, 417);
			this->label1->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(369, 40);
			this->label1->TabIndex = 51;
			this->label1->Text = L"Indication:\r\nDroit: 1->Administrateur, 2->Utilisateur, 3->Agencier";
			// 
			// UpdateUser
			// 
