...
namespace Project3 {
	...
	/// </summary>
	public ref class RemoveUser : public System::Windows::Forms::Form
	{
	public:
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Ajouter->Click += gcnew System::EventHandler(this, &RemoveUser::Ajouter_Click);
			// 
			// Cancel
			// 
			...
			this->Cancel->Click += gcnew System::EventHandler(this, &RemoveUser::Cancel_Click);
			// 
			// RemoveUser
			// 
			...
			this->Text = L"Supprimer Utilisateur";
			this->Load += gcnew System::EventHandler(this, &RemoveUser::RemoveUser_Load);
...
#pragma endregion
	private: System::Void deleteUser(int id){
				 MySqlCommand^ cmdDataBase = gcnew MySqlCommand("Delete from greensoft.utilisateur where IDUtilisateur=" + id + ";", con);
	...
	private: System::Void RemoveUser_Load(System::Object^  sender, System::EventArgs^  e) {
				 MySqlCommand^ cmdDataBase = gcnew MySqlCommand("Select * from greensoft.utilisateur;", con);
				 //MySqlDataReader^ myReader;
